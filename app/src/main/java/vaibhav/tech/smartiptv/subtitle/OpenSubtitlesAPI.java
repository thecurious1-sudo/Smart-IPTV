...
package vaibhav.tech.smartiptv.subtitle;
...
/**
 *   Copyright (C) 2013  @author Marcel Pint�, Hardsoft studio
 *   
...
///////////////////////// CODE FOR INTERNAL PROCCESSING ////////////////////////////////////	
	...
	private byte[] base64decode(String encoded) throws IOException {
		byte[] output = android.util.Base64.decode(encoded, Base64.DEFAULT);
		return output;
	}
